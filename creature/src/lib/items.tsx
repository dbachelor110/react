...
// const getTextMarker = (p5:P5CanvasInstance) => {
//     let i = 0;
...
// export default { addPointPair, rightHands, leftHands, rightLegs, leftLegs, heads, bodys, mouths, eyes, accessories };
import { P5CanvasInstance } from "@p5-wrapper/react"
...
const line = (p5:P5CanvasInstance, fromPoint:Point, toPoint:Point)=>p5.prototype.line(fromPoint.x, fromPoint.y, toPoint.x, toPoint.y);
...
const getBezierPointMarker = (p5:P5CanvasInstance ,point: BezierVertex, textMarker: (point: Point) => void = (point: Point) => { point }) => {
    let ExPoint: Point;
    const markBezierPoint = () => {
        if (point.firstPull && point.seccendPull && ExPoint) {
            p5.prototype.strokeWeight(5);
